...
# This script performs a reconstruction of the image during whihc movement occurs, but just a single image is reconstructed
# Three different time frames are used, during which movement occurs
# The movement between frames is modeled by a rotation and shift of the head
...
#        for i in nrtimessets        
        ...
        error_sin0 = measured/simulated0
